...
comic.addPanel(panel({
  ...
  figures: [
    figure('Max', {
      ...
      x: 130, y: 165, stroke: '#2c3e50', hair: 'curly', scale: 1.05,
    }),
    figure('Max', {
      expression: 'surprised', pose: patDownPose,
      x: 390, y: 170, stroke: '#2c3e50', hair: 'curly', scale: 1.05,
    }),
  ],
  bubbles: [
...
comic.addPanel(panel({
  ...
  figures: [
    figure('Max', {
      ...
      x: 130, y: 170, stroke: '#2c3e50', hair: 'curly', scale: 1.05,
    }),
    figure('Max', {
      expression: 'laughing', pose: POSES.armsUp,
      x: 390, y: 160, stroke: '#2c3e50', hair: 'curly', scale: 1.05,
    }),
  ],
  bubbles: [
